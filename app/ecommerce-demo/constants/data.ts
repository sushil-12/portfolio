...
export const trendingProducts: Product[] = [
  {
    ...
    price: '$35',
    href: '#',
    imageSrc: '/ecom/products/product-1.png',
  ...
  },
  {
    ...
    price: '$35',
    href: '#',
    imageSrc: '/ecom/products/Image-living-room.png',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
      { name: 'Black', colorBg: '#111827' },
      { name: 'Brass', colorBg: '#FDE68A' },
  ...
  },
  {
    ...
    price: '$35',
    href: '#',
    imageSrc: '/ecom/products/bedroom.png',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
      { name: 'Black', colorBg: '#111827' },
      { name: 'Brass', colorBg: '#FDE68A' },
...
export const productsWithOldPrices: singleProduct[] = [
  {
    ...
    price: 2500000,
    imageSrc: '/ecom/products/Syltherine.png',
    oldPrice: 3500000,
    discount: "-30%",
    status: "New",
  ...
  },
  {
    ...
    price: 2500000,
    oldPrice: 3500000,
    imageSrc: '/ecom/products/Respira.png',
    discount: "-30%",
    status: "New",
    actions: ["Add to cart", "Share", "Compare", "Like"]
  },
  {
    ...
    price: 7000000,
    imageSrc: '/ecom/products/Lolito.png',
    oldPrice: 14000000,
    discount: "-50%",
    status: "New",
    actions: ["Add to cart", "Share", "Compare", "Like"]
  ...
  },
  {
    ...
    price: 1500000,
    imageSrc: '/ecom/products/Grifo.png',
    oldPrice: 3500000,
    discount: "-30%",
    status: "New",
    actions: ["Add to cart", "Share", "Compare", "Like"]
  },
  {
    ...
    price: 150000,
    imageSrc: '/ecom/products/Muggo.png',
    oldPrice: 3500000,
    discount: "-30%",
    status: "New",
    actions: ["Add to cart", "Share", "Compare", "Like"]
  },
  {
    ...
    price: 7000000,
    imageSrc: '/ecom/products/Pingky.png',
    oldPrice: 14000000,
    discount: "-50%",
    status: "New",
    actions: ["Add to cart", "Share", "Compare", "Like"]
  },
  {
    ...
    price: 500000,
    oldPrice: 14000000,
    imageSrc: '/ecom/products/Potty.png',
    discount: "-50%",
    status: "New",
    actions: ["Add to cart", "Share", "Compare", "Like"]
  }
